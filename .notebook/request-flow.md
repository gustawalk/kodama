...
- `src/App.tsx:chooseSourceFile()` creates a linked collection from the OpenAPI document title when the workspace has no collections; later source changes use the same sync path as existing collections.
